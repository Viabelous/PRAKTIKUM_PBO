...
public class MenuSection{
    ...
    final public int AdminMenu(String Active, String SAd){
        System.out.println("""
    ...
    final public int UserMenu(String Active){
    ...
    final public int MainMenu(String Active, String SAd, boolean Admin){
        cls();
        getBorder();
        if(Admin){
