...
/* [ Versi Program 03 ]
   -. Manajemen Akun belum tersedia.

   -. CRUD Keranjang belum tersedia.

   -. Belum tersedia catatan pembelian.
...
public class main {
    ...
    static superAdmin SuperAdm = new superAdmin(0, "Yafi", "Viabel", "Viabel", "StressPosttest@gmail.com", "admin");
        
    public static void main(String[] args) throws IOException {
        
        // Inisialisasi
        int opsi, getId, index, equipBuy, priceH, priceP;
        ...
        while(stats1){
            ...
            while(stats2){
                ...
                switch(opsi){
                    ...
                    case 2:
                        ...
                        // Tambah AKun
                        dataAkun.add(new akun(index, null, null, null, null, null));
                        try{
            ...
            if(admin == true){
                System.out.println("""
                                   ...
                                   | --------------------------------
                                   """
                                 + ((activeUser.equals(SuperAdm.getUsn()))?
                                   """
                                   | --[9] Tambah Akun Admin
                                   | --[10] Lihat Daftar Akun Admin
                                   | --------------------------------
                                   """ : "")
                ...
                case 100:
                    ...
                    for (int i = 0; i < keranjangP.size(); i-=-1){
                        if(keranjangP.get(i).USP.equals(activeUser)){
                            System.out.println(" " + (i+1) + ". " + keranjangP.get(i).Nama
